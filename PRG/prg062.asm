...
;
; FILENAME: prg030.bin, File Size: 8193,.base: $8000
;     -> NES mode enabled
;---------------------------------------------------------------------------
...
; RegEx S&R:
; LDA LL_ShapeDef.*\n.*AND #\$0f.*\n.*STA Temp_Var(.)		 ; .*
; LDA LL_ShapeDef\n\tAND #$0f\n\tSTA Temp_Var_1		 ; Temp_Var_1 = lower 4 bits of LL_ShapeDef

; LDA LL_ShapeDef.*\n.*AND #\$0f.*\n.*TAX		 ; .*
; LDA LL_ShapeDef\n\tAND #$0f\n\tTAX		 ; X = lower 4 bits of LL_ShapeDef

; LDA Temp_Var(.).*\n.*STA Temp_Var(.)		 ; .*
; LDA Temp_Var_1\n\tSTA Temp_Var\2		 ; Temp_Var\2 = Temp_Var_1

; DEC Temp_Var(.)		 ; .*
; DEC Temp_Var_1		 ; Temp_Var_1--
...
TileLayoutPage_ByTileset:
	...
	.byte 11 ; 0 - Map [11]
	.byte 15 ; 1 - Plains [15]
	.byte 21 ; 2 - Mini fortress style [21]
	.byte 16 ; 3 - Hills style [16]
	.byte 17 ; 4 - High-Up style [17]
	.byte 36 ; 5 - Ghose House [36]
	.byte 18 ; 6 - Water world [18]
	.byte 18 ; 7 - Toad house [18]
	.byte 18 ; 8 - Vertical pipe maze [18]
	.byte 20 ; 9 - desert level [20]
	.byte 23 ; 10 - airship [23]
	.byte 19 ; 11 - Giant World [19]
	.byte 17 ; 12 - ice level [17]
	.byte 19 ; 13 - coin heaven / sky level [19]
	.byte 13 ; 14 - underground [13]
	.byte 45 ; 15 - ext [45]
	.byte 22 ; 16 - spade game sliders [22]
	.byte 22 ; 17 - N-spade [22]
	.byte 14 ; 18 - 2P Vs [14]
	.byte 22 ; 19 - bonus game intro [22]
