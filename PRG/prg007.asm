...
PRG007_A027:
	...
	LDA #$01
	STA <var3	 ; var13 = 1 (implied high byte / carry)
	
SpecTile_Not32PP:
	LDA <var5
	AND #$F0
	STA <var5	; Align to tile grid

	LDA <player_lo_x	; Get Player X
	ADD #$08	; +8
	...
	; Store high byte of screen address -> var1
	LDA Tile_Mem_Addr,Y
	STA <var1	

	; Store low byte of screen address + Player's Y Hi -> var2
...
PRG007_A070:
	STA <var1     ; Store the tile to check
...
PRG007_A0DE:
	...
	; var6 = 0 (would be "X Hi", which is always zero in vertical level)
	LDY #$00
	STY <var6

	LDA [var1],Y	 ; Get tile here
...
PRG007_A144:
	STX <var3		; var3 = index we just searched

PRG007_A146:
	DEX		 ; X--
	BPL PRG007_A12E	 ; While X >= 0, loop!

	LDX <var3	 ; X = free object slot!
...
SKF_UseGiantAlt:
	...
	; var1 = toggled vertical flip bit
	LDA <Counter_1
	LSR A
	LSR A
	LSR A
...
PRG007_A2E3:
	...
	LDY <player_flipped_animation	; Keep in mind this is generally only $00 or $40 since Player doesn't vertically flip/etc.
...
PRG007_A7C9:
	...
	LDX <entity_index	 ; Restore 'X' as slot index
...
PRG007_A845:
	LDX <entity_index	 ; X = slot backup
...
Bubbles_UpdateAndDraw:
	LDX #$03	 ; X = 3
PRG007_A86A:
	STX <entity_index	 ; -> Slot index backup
...
PRG007_A89A:
	...
	ADD #10		; Bubble Y + 10
	AND #$f0
	STA <var3	; var3 = bubble row (offset into tile memory)

	LDA Bubble_YHi,X
	ADC #HIGH(Tile_Mem)
	STA <var2	; var2 = bubble high offset into tile memory

	; Create row/column offset into tile memory for current screen of bubble -> var1
	LDA Bubble_X,X
	LSR A
	LSR A
	LSR A
...
PRG007_A8BF:
	...
	LDA Tile_Mem_Addr,Y
	STA <var1	 ; var1 = low byte of this screen's tile memory address
...
PRG007_A8F0:
	LDA [var1],Y ; Get the tile the bubble detects

	PHA		 ; Save it

	; Get tile "quadrant" -> var1
	ASL A
	ROL A
	ROL A
	AND #$03
...
Splash_Draw:
	...
	STY <var1	 ; Sprite RAM offset -> var1
...
PRG007_A9D5:
	...
	LDX <entity_index	 ; X = splash index
...
PRG007_AA8F:
	STX <entity_index	 ; Update entity_index
...
PRG007_AB02:
	LDX <entity_index	; X = score slot index
...
PRG007_AB99:
	LDY <var6	 ; Y = second sprite offset
	CPY #$ff
...
PRG007_AC7A:
	LDA BrickBust_HEn,X
	STA <var4	 ; Horizontal enable flag -> Var4
...
PRG007_AD54:
	...
	ROR A
	AND #SPR_VFLIP
	STA <var1	 ; Periodically vertically flip
	...
	LDX <entity_index	 ; X = restore slot index
...
PRG007_AE02:
	...
	LDX <entity_index	; X = power up coin slot index
...
CannonFire_UpdateAndDraw:
	...
	LDX #$07	 ; X = 7
PRG007_BB78:
	STX <entity_index	 ; Update index backup
...
CFire_Cannonball:
	...
	; var1 = this particular Cannon Fire ID
	LDA CannonFire_ID,X
	STA <var1
...
PRG007_BC81:
	STY <var1	 ; var1 = $12 (if right-shooting) or $09 (if left-shooting)

	STA <entity_lo_x_velocity,X	 ; X velocity = -$30 or $30, depending on direction
...
PRG007_BCE9:
	...
	LDA #-$08	 ; A = -$08
	DEC <var2	 ; var2 = $FF (16-bit sign extension)
PRG007_BCFC:
	ADD CannonFire_X,Y
	STA <entity_lo_x,X
	LDA CannonFire_XHi,Y
...
CFire_GoombaPipe:
	...
	STY <var2		 ; Store directional flag -> var2

	LDY <entity_index	 ; Y = Cannon Fire index
...
PRG007_BE69:
	...
	DEC <var3	 ; var3 = $FF (16-bit sign extension)
...
PRG007_BE91:
	...
	STA SpecialObj_YLo,Y
	LDA CannonFire_YHi,X
	ADC <var3		; 16-bit sign extension
	STA SpecialObj_YHi,Y	
...
PRG007_BEAA:
	...
	; from Cannon Fire's position by var1 which indexes CannonPoof_X/YOffs
CannonFire_NoiseAndSmoke:
	...
	CLC
	LDX <var1		; X = var1 holds the index into CannonPoof_XOffs
	ADC CannonPoof_XOffs,X	; + CannonPoof_XOffs[var1]
	SUB <Horz_Scroll	; Make relative to horizontal scroll
	STA BrickBust_X		; Set X

	LDA CannonPoof_YOffs,X	 ; A = CannonPoof_YOffs[var1]
...
CFire_BulletBill:
	...
	LDY <entity_index	 ; Y = Cannon Fire object slot
...
PRG007_BF80:
	STA entity_type,X	 ; Store Bill's ID
	...
	LDA CannonFire_X,Y
	STA <entity_lo_x,X
	STA entity_var13,X	; original X hold
