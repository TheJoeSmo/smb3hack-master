...
;
; FILENAME: prg027.bin, File Size: 8193,.base: $A000
;     -> NES mode enabled
;---------------------------------------------------------------------------
...
PRG027_A648:
	...
	BNE PRG027_A667	 ; If object has sprites horizontally or vertically off-screen, jump to PRG027_A667 (.baseet it!)

	LDX Objects_State,Y	; X = object's state
	LDA Obj2Obj_EnByState,X
	BNE PRG027_A667	 ; If this state does not support object-to-object (object-to-Projectile), jump to PRG027_A667 (.baseet it!)
