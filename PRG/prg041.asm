...
;
; FILENAME: prg001.bin, File Size: 8193,.base: $A000
;     -> NES mode enabled
;---------------------------------------------------------------------------
	...
	.base ObjectGroup_InitJumpTable	; <-- necessary in this bank due to short count
...
Yoshi_IgnoreObjectIDs_End
	...
	.base ObjectGroup_NormalJumpTable	; <-- necessary in this bank due to short count
ObjectGrExt_NormalJumpTable:
	...
	.base ObjectGroup_CollideJumpTable	; <-- necessary in this bank due to short count
ObjectGrExt_CollideJumpTable:
	...
	.base ObjectGroup_Attributes	; <-- necessary in this bank due to short count
ObjectGrExt_Attributes:
	...
	.base ObjectGroup_Attributes2	; <-- necessary in this bank due to short count
ObjectGrExt_Attributes2:
	...
	.base ObjectGroup_Attributes3	; <-- necessary in this bank due to short count
ObjectGrExt_Attributes3:
	...
	.base ObjectGroup_PatTableSel	; <-- necessary in this bank due to short count
ObjectGrExt_PatTableSel:
	...
	.base ObjectGroup_Attributes4	; <-- necessary in this bank due to short count
ObjectGrExt_Attributes4:
	...
	.base ObjectGroup_PatternStarts	; <-- necessary in this bank due to short count
ObjectGrExt_PatternStarts:
	...
	.base ObjectGroup_PatternSets	; <-- necessary in this bank due to short count
